...
### Scripts and analyses  
 ...
 MATRIX_sourcesink.Rmd - R markdown script for analysis using SourceTracker. Requires only sourcesink zip files and downloading [sourcetracker.r](https://github.com/danknights/sourcetracker).  
